#!/usr/bin/env python3
"""Ayran Notes — Application entry point.
...
from ayrannotes import __version__
...
def main() -> None:
    """Launch the Ayran Notes application."""
    app = QApplication(sys.argv)
    app.setApplicationName("Ayran Notes")
    app.setApplicationVersion(__version__)
    app.setWindowIcon(
        QIcon(str(files("ayrannotes").joinpath("assets", "ayrannotes.png")))
    )
